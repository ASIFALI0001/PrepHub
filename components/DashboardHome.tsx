...
const quickActions = [
  {
    ...
    icon: GraduationCap,
    label: "Learn",
    desc: "Browse curated Q&A",
    color: "text-accent-blue",
    bg: "bg-accent-blue/10 hover:bg-accent-blue/15",
  ...
  },
  {
    ...
    icon: Zap,
    label: "Quiz",
    desc: "Start a timed session",
    color: "text-accent-cyan",
    bg: "bg-accent-cyan/10 hover:bg-accent-cyan/15",
  ...
  return (
    <main className="pt-24 md:pt-20 pb-16 px-6 min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          {[
            { icon: Flame, label: "Day Streak", value: "—", color: "text-accent-orange" },
            { icon: BarChart3, label: "Accuracy", value: "—", color: "text-accent-green" },
            { icon: Trophy, label: "Interviews", value: "—", color: "text-accent-cyan" },
          ].map(({ icon: Icon, label, value, color }) => (
            <div key={label} className="glass-card rounded-xl border border-bg-border p-4 sm:p-5">
          ...
          <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
            <div>
              ...
              <p className="text-sm text-text-muted max-w-md">
                Gemini plays your interviewer. Answer via voice, get scored in real-time, and receive a full report with strengths and weak areas.
              </p>
            </div>
